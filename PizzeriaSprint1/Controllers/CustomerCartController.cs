...
namespace PizzeriaSprint1.Controllers
{
    public class CustomerCartController : Controller
    {
        ...
        /// <summary>
        /// This GET method redirects to  Home Page displaying all Pizzas available for buying by the customer.
        /// </summary>
        /// <returns></returns>
        ...
        /// the cart by the customer, he/she can again go back to his home page to add more items.
        /// </summary>
        /// <returns></returns>
